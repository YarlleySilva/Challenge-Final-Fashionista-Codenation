...
import { onSelectSize, showAddCartAlert, hideAddCartAlert } from "../../actions/products";
      ...
      <>
        ...
        <section className="selected-product__description">
          ...
          <span className="selected-product__price selected-product__price--parcel">
            <strong>Em até</strong> {item.installments}
          </span>
          ...
          <Link className="link link--back" to="/">
            <FaArrowAltCircleLeft className="icon icon--back" />
            Voltar
          </Link>
        </section>
      </>
